...
<center>
   ...
   <div class="buttons">
            ...
            <a href="leaderboard.jsp"><button type="button" class="btn btn-dark">View Global Ranking</button></a>
            <a href="leaderboard2.jsp"><button type="button" class="btn btn-light">View Institute Ranking</button></a>
...
<%
	...
	try {
		...
		String sql = ("SELECT U.UNAME, U.UMAIL, U.INSTITUTE, CS.OVERALL_SCORE FROM CODESTATION AS CS, USER AS U WHERE U.UMAIL=CS.UMAIL ORDER BY CS.OVERALL_SCORE DESC ;");
